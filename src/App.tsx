...
function App() {
  return (
    <main className="h-full w-full bg-grey-200">
      <Grid>
        <Card
          ...
          footer={"About"}
        />
        <Card order="order-2 md:order-2 lg:order-2"></Card>
        <Card order="order-3 md:order-3 lg:order-4">
          <div className="flex items-center justify-center content-center h-full w-full bg-[#0B65C2]">
        ...
        <Card order="order-5 md:order-4 lg:order-10">
